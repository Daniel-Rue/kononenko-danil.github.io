        ...
        <tr>
            <td valign="top" width="583" height="208" background="images/row1.gif">
                ...
                <div style="margin-left:50px; margin-top:69px ">
                    ...
                    <a href="">Заказ<img src="images/m2.gif" border="0"></a>
                    <img src="images/spacer.gif" width="5" height="10">
                    <a href="">Корзина<img src="images/m3.gif" border="0"></a>
                    <img src="images/spacer.gif" width="5" height="10">
                    <a href="">О компании<img src="images/m4.gif" border="0"></a>
                    <img src="images/spacer.gif" width="5" height="10">
                    <a href="">Контакты<img src="images/m5.gif" border="0"></a>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td width="492" valign="top" height="106">
                                        ...
                                        <form method="post" action="index.php" style="font-family:Tahoma; font-size:10px;  color:#7C994A; text-decoration:none ">
